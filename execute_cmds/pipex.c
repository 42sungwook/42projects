...
// /*   Updated: 2023/04/28 21:36:19 by daijeong         ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */
...
// 	pid = 0;
// 	first_child_process(cmds, pid);
// 	sign = nth_child_process(cmds, pid);
// 	if (sign == 1)
// 		pid = last_child_process1(cmds);
// 	else
// 		pid = last_child_process2(cmds);
// 	i = 0;
